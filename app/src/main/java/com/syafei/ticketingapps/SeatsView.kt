...
class SeatsView : View {
    ...
    constructor(context: Context, attributeSet: AttributeSet, dfstyleAttr: Int) : super(
        context,
        attributeSet,
        dfstyleAttr
    ) {
    ...
    //informasi posisi x dan y melalui metode onMeasure
    ...
    //Menggambar kursi berdasarkan informasi kursi yang didapatkan melalui metode onDraw
    override fun onDraw(canvas: Canvas?) {
        ...
        val text = "silakan pilih bangku bang"
        titlePaint.apply {
            textSize = 50F
        }
        canvas?.drawText(text, (width / 2) - 260f, 100f, titlePaint)
    }
